...
void runsim (int serial) {
    ...
    vector<string> out_buffer, out_buffer2;
    ...
    //sim.Now = 9;
    //sim.rand_infect(3, nodes[0]);//*2
    //sim.rand_infect(7, nodes[1]);//*2
    ...
    string out_fname = "/projects/b1139/covid-age-output/2pop/daily_output." + to_string(serial);
